\begin{small}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[black,mark=*] table[x=thread,y=speedup]{fig/cache/uniform-50k/mcore_cache_modulo_uniform.txt};
      \addlegendentry{Local LB}
      \addplot[black,mark=o] table[x=thread,y=speedup]{fig/cache/uniform-50k/mcore_cache_roundrobin_uniform.txt};
