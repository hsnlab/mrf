...
\begin{small}
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot[SelfAdjustingSimMark,mark size=2pt] table[x=thread,y=speedup]{fig/cache/uniform-50k-2/mcore_cache_modulo_uniform.txt};
      % \addlegendentry{Local LB}
      \addplot[SelfAdjustingSimMark,mark=pentagon*,mark size=3pt] table[x=thread,y=speedup,each nth point={2}]{fig/cache/uniform-50k-2/mcore_cache_roundrobin_uniform.txt};
