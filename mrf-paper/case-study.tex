...
\begin{figure*}
  ...
  %   \resizebox{.225\textwidth}{!}{\input{fig/classbench-acl1.tex}}\label{fig:classbench-acl1}}
  % \subfloat[][ipc1]{
  %   \resizebox{.225\textwidth}{!}{\input{fig/classbench-ipc1.tex}}\label{fig:classbench-ipc1}}
  % \subfloat[][fw1]{%
  %   \resizebox{.225\textwidth}{!}{\input{fig/classbench-fw1.tex}}\label{fig:classbench-fw1}}
  % \subfloat[][Synthetic traffic]{
  %   \resizebox{.225\textwidth}{!}{\input{fig/rule-size.tex}}\label{fig:rule-size}}
