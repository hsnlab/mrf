...
\begin{figure*}
  ...
  \caption{ClassBench results on three rulesets with roughly 5000 rules coming from different seeds: acl1, ipc1, and fw1.}
...
\begin{figure}
  ...
  \caption{Speedup with different rule sizes.}
  \label{fig:rule-size}
\end{figure}
