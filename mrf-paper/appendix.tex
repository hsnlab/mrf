...
\begin{definition}
The value $q$ is defined the ratio of the total work to the completion time of the last machine.
\end{definition}
...
In the former model, we can have a polynomial time algorithm constant-factor approximation~\cite{Andersson99}, and in the latter model, we can have a polylogarithmic approximation~\cite{AndreevR06}.
