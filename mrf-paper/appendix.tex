...
% In fact, monotonicity of $g_D$ is a sufficient condition for our theorem to hold.
...
The ratio of the total work to the completion time of the last machine is $q$.
...
% If work is perfectly parallelizable, then in the completion time of any job schand the speedup is linear in $k$. Ou 


% \paragraph*{Our scaling.}
