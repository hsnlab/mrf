...
This theorem follows from the Theorem~\ref{thm:superlinear} and Observation~\ref{obs:initial}.
...
The proof of the above theorem is a direct consequence of the definitions of $\ell$ and $q$ and our cost model. We leave the proof to the full version of the paper.
